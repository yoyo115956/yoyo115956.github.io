...
```yml
# Site settings
title: 李泳霆的博客             # title of your website
SEOTitle: LiYongTing Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: yoyo115956     # modify this account to yours
weibo_username: yoyo115956      # the footer woule be auto-updated.
