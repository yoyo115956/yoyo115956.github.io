...
这个部分将针softmax回归的从零开始实现操作：初始化模型参数、定义softmax操作、定义模型、定义损失函数、分类精度、训练、预测。
...
(**
$$
\mathrm{softmax}({X})_{ij} = \frac{\exp({X}_{ij})}{\sum_k \exp({X}_{ik})}.
$$
**)
...
```
(tensor([[0.1376, 0.5514, 0.0657, 0.1196, 0.1258],
         [0.0722, 0.3277, 0.2701, 0.0721, 0.2580]]),
...
<img src="https://s2.loli.net/2024/01/28/47y68VZBPt1zTnO.png" alt="image-20240128001405807" style="zoom:67%;" />
...
![image-20240127141535869](https://s2.loli.net/2024/01/27/lyr7ENsQeWd3Zfz.png)
