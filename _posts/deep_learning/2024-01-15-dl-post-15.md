...
暂退法(Dropout)：重新审视过拟合、扰动的稳健性、实践中的暂退法、从零开始实现（定义模型参数、定义模型、训练和测试）、简洁实现。
...
![image-20240227232514044](https://s2.loli.net/2024/02/27/vRLraT2Wby9tVPz.png)
:label:`fig_dropout2`
...
![image-20240227214932550](https://s2.loli.net/2024/02/27/kdl3yREqYiC4sMF.png)
...
![image-20240227215002666](https://s2.loli.net/2024/02/27/ZX9Vn67Sl8sdPE5.png)
