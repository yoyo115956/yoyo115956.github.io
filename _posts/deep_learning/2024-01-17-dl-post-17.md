...
![image-20240227230104700](https://s2.loli.net/2024/02/27/pw5RJHbGkWhYrxZ.png)
:width:`400px`
:label:`fig_kaggle`
...
![image-20240227230140293](https://s2.loli.net/2024/02/27/DcbKErgW7HQGBFw.png)
:width:`400px`
...
```
    ...
    折1，训练log rmse0.170063, 验证log rmse0.156719


    折2，训练log rmse0.161831, 验证log rmse0.189599


    折3，训练log rmse0.163745, 验证log rmse0.168297


    折4，训练log rmse0.167671, 验证log rmse0.154260


    折5，训练log rmse0.163440, 验证log rmse0.183081
    5-折验证: 平均训练log rmse: 0.165350, 平均验证log rmse: 0.170391


![image-20240227230301188](https://s2.loli.net/2024/02/27/6nG7W52gKzkUmvq.png)
...
![image-20240227230326380](https://s2.loli.net/2024/02/27/YrN5aopgcbPKHGO.png)
...
![image-20240227230417622](https://s2.loli.net/2024/02/27/bthVmSKFDoT3fp1.png)
:width:`400px`
