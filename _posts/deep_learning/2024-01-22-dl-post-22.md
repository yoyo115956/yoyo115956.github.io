...
```
    ...
    | N/A   49C    P8    N/A /  N/A |    725MiB /  2048MiB |      0%      Default |
    |                               |                      |                  N/A |
    +-------------------------------+----------------------+----------------------+
    ...
    |        ID   ID                                                   Usage      |
    |=============================================================================|
    |    0   N/A  N/A      2136      C   /python3.8                      N/A      |
    +-----------------------------------------------------------------------------+
...
```
    ...
    tensor([[0.3186, 0.9175, 0.4510],
            [0.8275, 0.6989, 0.3924]], device='cuda:0')
...
```
    ...
    tensor([[1.3186, 1.9175, 1.4510],
            [1.8275, 1.6989, 1.3924]], device='cuda:0')
...
```
    ...
    tensor([[-0.4580],
            [-0.4580]], device='cuda:0', grad_fn=<AddmmBackward0>)
