...
![image-20240229132601364](https://s2.loli.net/2024/02/29/QcsIGZlYOXS7zfJ.png)
:label:`fig_filters`
...
注意，本书在这里提供的是一个稍微精简版本的AlexNet，去除了当年需要两个小型GPU同时运算的设计特点。![image-20240229132629820](https://s2.loli.net/2024/02/29/sYkLe3c1Gj6JO5M.png):label:`fig_alexnet`
...
```
    ...
    3637.4 examples/sec on cuda:0


![image-20240229132723886](https://s2.loli.net/2024/02/29/lyL5RBCjaMPot6W.png)
